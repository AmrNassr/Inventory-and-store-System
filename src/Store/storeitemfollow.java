...
public final class storeitemfollow extends javax.swing.JInternalFrame {
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        try {
            String sqll = "SELECT sell,buy,number,category,name,serial FROM eslam.storeitem WHERE  1=1 ";
...
public void clear() {
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT sell,buy,number,category,name,serial FROM eslam.storeitem";
            pst = (PreparedStatement) con.prepareStatement(sqll);
            rs = pst.executeQuery();
            DefaultTableModel model = (DefaultTableModel) tdetails.getModel();
            model.setRowCount(0);
