...
public final class buyitems11 extends javax.swing.JInternalFrame {
    ...
    public buyitems11() {
        try {
            ...
            String sqll = "SELECT *  FROM eslam.sellbattryitems WHERE mark='No'  ";
            ...
            while (rs.next()) {
                ...
                String sqla1d = "UPDATE eslam.storeitemlist SET number =number+" + numberr + "   where barcode='" + barcodee + "'";
                pst = (PreparedStatement) con.prepareStatement(sqla1d);
                pst.executeUpdate();
            }
            String sql = "DELETE FROM eslam.sellbattryitems WHERE mark='No'";
            pst = (PreparedStatement) con.prepareStatement(sql);
            pst.execute();
            String sqlz = "DELETE FROM eslam.storeitemlogs WHERE mark='DD'";
    ...
    private void cmcustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmcustomerActionPerformed
        ...
        if (obj == cmcustomer) {
            ...
            try {
                String sqll = "SELECT *  FROM eslam.customer  where name='" + cmcustomer.getSelectedItem().toString() + "'  ";
    ...
    private void paidKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_paidKeyReleased
        try {
            double amount = Double.parseDouble(totalbill.getText());
            double paidd = Double.parseDouble(paid.getText());
            double khasm = Double.parseDouble(khsm.getText());
            double totall = amount - paidd - khasm;
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        try {
            double totalk = Double.parseDouble(totalbill.getText());
            double paidk = Double.parseDouble(paid.getText());
            double khsmm = Double.parseDouble(khsm.getText());
            double remainingk = totalk - paidk - khsmm;
            if (totalk >= (paidk + khsmm) && !paid.getText().trim().isEmpty()) {
                if (cmcustomer.getSelectedIndex() != 0) {
                    ...
                    String sql = "INSERT INTO eslam.sellbattry (buyserial,customerserial,total,paid,remaining,datee,fulldate,customername,khsm) VALUES"
                            + " ('" + seriall + "','" + customerseriall + "','" + totalk + "',"
                            + "'" + paidk + "','" + remainingk + "','" + datee1 + "','" + fulldatee + "','" + customername + "','" + khsmm + "')";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    pst.execute();

                    String sqldaf = "SELECT * FROM eslam.customeramount where name='" + customername + "' ";
                    pst = (PreparedStatement) con.prepareStatement(sqldaf);
                    rs = pst.executeQuery();
                    if (rs.next()) {
                        String sqla = "UPDATE eslam.customeramount SET total = total+" + remainingk + " WHERE  name='" + customername + "'";
                        ...
                        pst.execute();
                        if (paidk > 0) {
                            String sqll33 = "INSERT INTO eslam.customerlogs (name,type,date,fulldate,amount) VALUES"
                        ...
                        String sqla = "INSERT INTO eslam.customeramount (name,total) VALUES"
                    ...
                    String sqla1 = "UPDATE eslam.sellbattry SET mark ='Yes' WHERE  buyserial='" + seriall + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla1);
                    pst.executeUpdate();
                    String sqla2 = "UPDATE eslam.sellbattryitems SET mark ='Yes' WHERE  buyserial='" + seriall + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla2);
                    pst.executeUpdate();
                    String sqla21 = "UPDATE eslam.storeitemlogs SET mark ='Yes' WHERE  serial='" + seriall + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla21);
                    pst.executeUpdate();
                    String sqldaf1 = "SELECT * FROM eslam.sellbattryitems where buyserial='" + seriall + "' ";
                    pst = (PreparedStatement) con.prepareStatement(sqldaf1);
                    rs = pst.executeQuery();
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        if (dialogResult == 0) {
            try {
                String sql = "DELETE FROM eslam.sellbattryitems WHERE buyserial='" + serialbuy.getText() + "'";
                pst = (PreparedStatement) con.prepareStatement(sql);
                pst.execute();
                String sql1 = "DELETE FROM eslam.sellbattry WHERE  buyserial='" + serialbuy.getText() + "'";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        if (serialid.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    String seriall = serialbuy.getText();
                    String sql = "DELETE FROM eslam.sellbattryitems WHERE id='" + serialid.getText() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    pst.execute();
                    String sqld = "SELECT name FROM eslam.storeitemlist where barcode='" + itemcode3.getText() + "' ";
                    pst = (PreparedStatement) con.prepareStatement(sqld);
                    rs = pst.executeQuery();
                    while (rs.next()) {
                        String nameee = rs.getString("name");
                        String sql1 = "DELETE FROM eslam.storeitemlogs WHERE name='" + nameee + "' and serial = '" + seriall + "'";
                        pst = (PreparedStatement) con.prepareStatement(sql1);
                        pst.execute();

                    }

                    String sqla1 = "UPDATE eslam.storeitemlist SET number =number+" + number3.getText() + "   where barcode='" + itemcode3.getText() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla1);
                    pst.executeUpdate();
                    serialid.setText("");
                    itemcode3.setText("");
    ...
    private void paid1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_paid1KeyReleased
        try {
            double amount = Double.parseDouble(totalbill1.getText());
            double paidd = Double.parseDouble(paid1.getText());
            double totall = paidd - amount;
    ...
    private void save2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save2ActionPerformed
        try {
            double totalk = Double.parseDouble(totalbill1.getText());
            double paidk = Double.parseDouble(paid1.getText());
            double remainingk = totalk - paidk;
            if (totalk <= paidk && !paid1.getText().trim().isEmpty()) {
                ...
                String time = String.format("%02d", c.get(Calendar.HOUR_OF_DAY)) + ":"
                        + String.format("%02d", c.get(Calendar.MINUTE));
                String fulldatee = datee1 + " " + time;
                String sql = "INSERT INTO  eslam.sellbattry (buyserial,customerserial,total,paid,datee,fulldate,customername) VALUES"
    ...
    private void save3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save3ActionPerformed
        ...
        if (dialogResult == 0) {
            try {
                String sql = "DELETE FROM eslam.sellbattryitems WHERE buyserial='" + serialbuy1.getText() + "'";
                pst = (PreparedStatement) con.prepareStatement(sql);
                pst.execute();
                String sql1 = "DELETE FROM eslam.sellbattry WHERE  buyserial='" + serialbuy1.getText() + "'";
                pst = (PreparedStatement) con.prepareStatement(sql1);
                pst.execute();
                clear2();
                JOptionPane.showMessageDialog(rootPane, "تم مسح الفاتورة");
    ...
    private void add3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add3ActionPerformed
        ...
        try {
            double numbber = Double.parseDouble(number.getText());
            double pricee = Double.parseDouble(price1.getText());
            double total = numbber * pricee;
            String sqldaf = "SELECT * FROM eslam.storeitemlist where name='" + itemcode.getText() + "' ";
            pst = (PreparedStatement) con.prepareStatement(sqldaf);
            rs = pst.executeQuery();
            if (rs.next()) {
            ...
            if (available.trim().equals("") || available.trim().equals("0") || Integer.parseInt(number.getText()) > Integer.parseInt(available)) {
                ...
                try {
                    String sqla1d = "UPDATE eslam.storeitemlist SET number =number-(" + number.getText() + "-1)   where barcode='" + itemcode.getText() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla1d);
                    pst.executeUpdate();
                    String sqla111 = "UPDATE eslam.storeitemlogs SET number ='" + "-" + number.getText() + "'   where serial='" + seriall + "' and name = '" + nameitem + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla111);
                    pst.executeUpdate();
                    String sqla1 = "UPDATE eslam.sellbattryitems SET number ='" + numbber + "',total='" + total + "'  WHERE  id='" + serialid1.getText() + "' and buyserial='" + serialbuy1.getText() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla1);
                    pst.executeUpdate();
                    tablelord1();
                    String sqld = "SELECT total FROM eslam.sellbattryitems where datee='" + datee1 + "' and buyserial='" + seriall + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqld);
                    rs = pst.executeQuery();
                    while (rs.next()) {
    ...
    private void delete1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete1ActionPerformed
        ...
        if (serialid1.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    String sql = "DELETE FROM eslam.sellbattryitems WHERE id='" + serialid1.getText() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    pst.execute();
                    String sqld = "SELECT name FROM eslam.storeitemlist where barcode='" + itemcode.getText() + "' ";
                    pst = (PreparedStatement) con.prepareStatement(sqld);
                    rs = pst.executeQuery();
                    while (rs.next()) {
                        String nameee = rs.getString("name");
                    ...
                    String sqla1 = "UPDATE eslam.storeitemlist SET number =number+" + number.getText() + "   where barcode='" + itemcode.getText() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqla1);
                    pst.executeUpdate();
                    serialid1.setText("");
                    itemcode.setText("");
                    ...
                    number.setText("1");
                    tablelord1();
                    String sqldd = "SELECT total FROM eslam.sellbattryitems where datee='" + datee1 + "' and buyserial='" + seriall + "'";
                    pst = (PreparedStatement) con.prepareStatement(sqldd);
                    rs = pst.executeQuery();
                    while (rs.next()) {
                        amount = amount + (rs.getDouble("total"));
                    }
    ...
    private void itemcodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_itemcodeKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                String available = null;
                String seriall = serialbuy1.getText();
                String sqldaf = "SELECT * FROM eslam.storeitemlist where barcode='" + itemcode.getText() + "' ";
                pst = (PreparedStatement) con.prepareStatement(sqldaf);
                rs = pst.executeQuery();
                if (rs.next()) {
                    price1.setText(rs.getString("price"));
                    ...
                    if (itemcode.getText().toString().trim().isEmpty() || price1.getText().trim().isEmpty()) {
                        ...
                        try {
                            ...
                            String time = String.format("%02d", c.get(Calendar.HOUR_OF_DAY)) + ":"
                                    + String.format("%02d", c.get(Calendar.MINUTE));
                            String fulldatee = datee1 + " " + time;
                            String sqll = "SELECT * FROM eslam.sellbattryitems where item='" + itemcode.getText() + "'  and datee='" + datee1 + "' and buyserial='" + seriall + "'";
                            pst = (PreparedStatement) con.prepareStatement(sqll);
                            rs = pst.executeQuery();
                            if (rs.next()) {
                                String sqla11 = "UPDATE eslam.storeitemlist SET number =number-1   where barcode='" + itemcode.getText() + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla11);
                                pst.executeUpdate();
                                String sqla111 = "UPDATE eslam.storeitemlogs SET number =number-1   where serial='" + seriall + "' and name = '" + nameitem + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla111);
                                pst.executeUpdate();
                                String sqla1 = "UPDATE eslam.sellbattryitems SET number =number+1 ,total=total+ " + price1.getText() + " where item='" + itemcode.getText() + "'  and datee='" + datee1 + "' and buyserial='" + seriall + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla1);
                                pst.executeUpdate();
                                ...
                                String sqla1 = "UPDATE eslam.storeitemlist SET number =number-1   where barcode='" + itemcode.getText() + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla1);
                                pst.executeUpdate();

                                String sql = "INSERT INTO eslam.sellbattryitems (itemname,buyserial,item,customername,number,price,total,datee,fulldate,customerserial) VALUES"
                                        + " ('" + itemname.getText() + "','" + seriall + "','" + itemcode.getText() + "','-','" + number.getText() + "',"
                                        + "'" + price1.getText() + "','" + price1.getText() + "','" + datee1 + "','" + fulldatee + "','-')";
                                pst = (PreparedStatement) con.prepareStatement(sql);
                                pst.execute();
                                String sqll33 = "INSERT INTO eslam.storeitemlogs (serial,name,supplier,number,type,date,fulldate,price,mark) "
    ...
    private void itemcode3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_itemcode3KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                String available = null;
                String seriall = serialbuy.getText();
                String sqldaf = "SELECT * FROM eslam.storeitemlist where barcode='" + itemcode3.getText() + "' ";
                pst = (PreparedStatement) con.prepareStatement(sqldaf);
                rs = pst.executeQuery();
                if (rs.next()) {
                    ...
                    if (itemcode3.getText().toString().trim().isEmpty() || cmcustomer.getSelectedIndex() == 0 || price3.getText().trim().isEmpty()) {
                        ...
                        try {
                            ...
                            String time = String.format("%02d", c.get(Calendar.HOUR_OF_DAY)) + ":"
                                    + String.format("%02d", c.get(Calendar.MINUTE));
                            String fulldatee = datee1 + " " + time;
                            String sqll = "SELECT * FROM eslam.sellbattryitems where item='" + itemcode3.getText() + "'  and datee='" + datee1 + "' and buyserial='" + seriall + "'";
                            pst = (PreparedStatement) con.prepareStatement(sqll);
                            rs = pst.executeQuery();
                            if (rs.next()) {
                                String sqla11 = "UPDATE eslam.storeitemlist SET number =number-1   where barcode='" + itemcode3.getText() + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla11);
                                pst.executeUpdate();
                                String sqla111 = "UPDATE eslam.storeitemlogs SET number =number-1   where serial='" + seriall + "' and name = '" + nameitem + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla111);
...
//                              JOptionPane.showMessageDialog(rootPane, "العنصر تم اضافتة من قبل");
                                String sqla1 = "UPDATE eslam.sellbattryitems SET number =number+1 ,total=total+ " + price3.getText() + " where item='" + itemcode3.getText() + "'  and datee='" + datee1 + "' and buyserial='" + seriall + "'";
                                pst = (PreparedStatement) con.prepareStatement(sqla1);
                                pst.executeUpdate();
                                tablelord();
                                itemcode3.setText("");
    ...
    private void add4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add4ActionPerformed
        ...
        try {
            String sqldaf = "SELECT * FROM eslam.storeitemlist where name='" + itemcode3.getText() + "' ";
            pst = (PreparedStatement) con.prepareStatement(sqldaf);
            rs = pst.executeQuery();
            if (rs.next()) {
            ...
            try {
                String sqla1d = "UPDATE eslam.storeitemlist SET number =number-(" + number3.getText() + "-1)   where barcode='" + itemcode3.getText() + "'";
                pst = (PreparedStatement) con.prepareStatement(sqla1d);
                pst.executeUpdate();
                String sqla111 = "UPDATE eslam.storeitemlogs SET number ='" + "-" + number3.getText() + "'   where serial='" + seriall + "' and name = '" + nameitem + "'";
                pst = (PreparedStatement) con.prepareStatement(sqla111);
                pst.executeUpdate();
                String sqla1 = "UPDATE eslam.sellbattryitems SET number ='" + numbber + "',total='" + total + "'  WHERE  id='" + serialid.getText() + "' and buyserial='" + serialbuy.getText() + "'";
                pst = (PreparedStatement) con.prepareStatement(sqla1);
                pst.executeUpdate();
                tablelord();
                String sqld = "SELECT total FROM eslam.sellbattryitems where datee='" + datee1 + "' and buyserial='" + seriall + "'";
    ...
    public void tablelord() {
        try {
            String datee1 = year.getText() + "-" + month.getText() + "-" + day.getText();
            String sqll = "SELECT * FROM eslam.sellbattryitems where buyserial='" + serialbuy.getText() + "' "
    ...
    public void tablelord1() {
        try {
            String datee1 = year1.getText() + "-" + month1.getText() + "-" + day1.getText();
            String sqll = "SELECT * FROM eslam.sellbattryitems where buyserial='" + serialbuy1.getText() + "' "
    ...
    public void customer() {
        try {
            String sql = "SELECT name  FROM eslam.customer  order by name";
            pst = (PreparedStatement) con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public void auto_id() {
        ...
        try {
            String sqll = "SELECT buyserial FROM eslam.sellbattry where id=(select max(id)FROM eslam.sellbattry )";
            pst = (PreparedStatement) con.prepareStatement(sqll);
            rs = pst.executeQuery();
            if (rs.next()) {
