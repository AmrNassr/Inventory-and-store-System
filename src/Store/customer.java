        ...
        try {
            ...
            if (serialid4.getText().trim().isEmpty()) {
                ...
                if (name.getText().trim().isEmpty() || phone.getText().trim().isEmpty() )  {
                    ...
                    if (dialogResult == 0) {
                        try {
                            String sql = "INSERT INTO eslam.customer (name,phone,serial) VALUES"
                ...
                String sqla = "UPDATE eslam.customer SET name='" + namee + "',phone='" + phonee + "' where id = '" + serialid4.getText() + "'";
