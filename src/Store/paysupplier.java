...
public class paysupplier extends javax.swing.JFrame {
        ...
        try {
            ...
            if (totall < totall1) {
                ...
                if (dialogResult == 0) {
                    ...
                    try {
                        String sqla = "UPDATE eslam.storesupplieramount SET total = total-" + totall + " WHERE  supplier='" + cmname.getSelectedItem().toString() + "'";
  ...
  public void suppliers() {
        try {
            String sql = "SELECT distinct supplier  FROM eslam.storesupplieramount order by supplier ";
    ...
    public void comboxfromcombo1() {
        cmname.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    String sql = "SELECT total from eslam.storesupplieramount where supplier='" + cmname.getSelectedItem().toString() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    while (rs.next()) {
