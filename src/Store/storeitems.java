...
public final class storeitems extends javax.swing.JInternalFrame {
    ...
    private void save5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save5ActionPerformed
        try {
            ...
            String sqll = "SELECT * FROM eslam.storeitemlist WHERE  1=1 ";
        ...
        try {
            ...
            if (serialid.getText().trim().isEmpty()) {
                ...
                if (name.getText().trim().isEmpty() || price.getText().trim().isEmpty() || gomla.getText().trim().isEmpty() || barcode.getText().trim().isEmpty()) {
                    ...
                    if (dialogResult == 0) {
                        try {
                            String sql = "INSERT INTO eslam.storeitemlist (gomla,barcode,price,name,category) VALUES"
                ...
                try {
                    String sqla = "UPDATE eslam.storeitemlist SET name='" + namee + "',price='" + pricee + "',gomla='" + gomla.getText() + "', category='" + categoryy + "'"
...
public void clear() {
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM eslam.storeitemlist order by name";
            pst = (PreparedStatement) con.prepareStatement(sqll);
            rs = pst.executeQuery();
            DefaultTableModel model = (DefaultTableModel) tdetails.getModel();
            model.setRowCount(0);
    ...
    public void category() {
        try {
            String sql = "SELECT name  FROM eslam.storecategory order by name ";
            pst = (PreparedStatement) con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
