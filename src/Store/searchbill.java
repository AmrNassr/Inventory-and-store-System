...
public final class searchbill extends javax.swing.JInternalFrame {
    ...
    private void cmcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmcodeActionPerformed
        ...
        if (obj == cmcode) {
            try {
                String sqll = "SELECT *  FROM eslam.sellbattry where  buyserial='" + cmcode.getSelectedItem().toString() + "'";
        ...
        if (serialid.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    ...
                    pst = (PreparedStatement) con.prepareStatement(sqla1e);
                    pst.executeUpdate();
        ...
        try {
            ...
            try {
                ...
                if(secondnumber > firstnumber)
                {
                    ...
                    String sqla1d = "UPDATE eslam.storeitemlist SET number =number-(" + totall + ")   where barcode='" + itemcode3.getText() + "'";
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM eslam.sellbattryitems where buyserial='" + cmcode.getSelectedItem().toString() + "' order by id";
            pst = (PreparedStatement) con.prepareStatement(sqll);
            rs = pst.executeQuery();
    ...
    public void serials() {
        try {
            String sql = "SELECT buyserial  FROM eslam.sellbattry  order by buyserial";
            pst = (PreparedStatement) con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
