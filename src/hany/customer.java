...
public final class customer extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "خطاط", "استوديو" }));
        ...
        jPanel14.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 90, 230, 30));
        ...
        jPanel14.add(phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 140, 230, 30));
    ...
    private void delete4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete4ActionPerformed
        if (serialid4.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    String sql = "DELETE FROM eslam.customer WHERE id='" + serialid4.getText() + "'";
        ...
        try {
            ...
            if (serialid4.getText().trim().isEmpty()) {
                ...
                if (name.getText().trim().isEmpty() || phone.getText().trim().isEmpty() )  {
                    ...
                    if (dialogResult == 0) {
                        try {
                            String sql = "INSERT INTO eslam.customer (name,type,phone,serial) VALUES"
                ...
                String sqla = "UPDATE eslam.customer SET name='" + namee + "',type='" + type + "',phone='" + phonee + "' where id = '" + serialid4.getText() + "'";
    ...
    private void save5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save5ActionPerformed
        try {
            ...
            String sqll = "SELECT * FROM eslam.customer WHERE  1=1 ";
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM eslam.customer order by id ";
            pst = (PreparedStatement) con.prepareStatement(sqll);
            rs = pst.executeQuery();
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            model.setRowCount(0);
...
public void privateauto_id(){
         ...
         try {
             String sql = "SELECT serial FROM eslam.customer ORDER BY id DESC LIMIT 1";
             pst=(PreparedStatement) con.prepareStatement(sql);
             rs=pst.executeQuery();
             if(rs.next()){
