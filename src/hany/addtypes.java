...
public final class addtypes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel14.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 190, 510, 280));
        ...
        jPanel14.add(cmkind, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 120, 100, 30));

        jLabel37.setBackground(new java.awt.Color(255, 255, 255));
        jLabel37.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel37.setText("نوع");
        jPanel14.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 110, 70, 40));
        ...
        jPanel14.add(delete4, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 510, 120, 40));

        jLabel15.setBackground(new java.awt.Color(255, 255, 255));
        jLabel15.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel15.setText("نوع المنتج");
        jPanel14.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 50, 140, 40));

        lname1.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel14.add(lname1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 50, 230, 40));
        ...
        jPanel14.add(save4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, 120, 40));
    ...
    private void delete4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete4ActionPerformed
        if (serialid4.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    String sql = "DELETE FROM eslam.itemtype WHERE id='" + serialid4.getText() + "'";
        ...
        try {
            ...
            if (serialid4.getText().trim().isEmpty()) {
                ...
                if (lname1.getText().trim().isEmpty()) {
                    ...
                    if (dialogResult == 0) {
                        try {
                            String sql = "INSERT INTO eslam.itemtype (name,type) VALUES"
                                    + " ('" + namee + "','"+type+"')";
                            pst = (PreparedStatement) con.prepareStatement(sql);
                            pst.execute();
                ...
                String sqla = "UPDATE eslam.itemtype SET name='" + namee + "',type='"+type+"' where id = '" + serialid4.getText() + "'";
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM eslam.itemtype";
