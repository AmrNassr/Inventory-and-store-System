...
public final class msrofat extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("موظف");
        jPanel10.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, 110, -1));

        cmtype2.setEditable(true);
        cmtype2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No", "Yes" }));
        jPanel10.add(cmtype2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 90, 200, 30));
        ...
        jPanel10.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 410, 80, -1));
        ...
        jPanel10.add(save1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 410, 100, 30));
        ...
        jPanel10.add(save3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 120, 40));

        typename.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jPanel10.add(typename, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 200, 30));

        jLabel28.setBackground(new java.awt.Color(255, 255, 255));
        jLabel28.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel28.setText("النوع");
        jPanel10.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 140, 110, -1));
        ...
        jPanel10.add(amount1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 450, 70, 30));

        jLabel25.setBackground(new java.awt.Color(255, 255, 255));
        jLabel25.setFont(new java.awt.Font("Arial", 1, 30)); // NOI18N
        jLabel25.setText("القيمه");
        jPanel10.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 450, 60, 30));
        ...
        jPanel10.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 450, 180, -1));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        try {
            ...
            if (cmtype.getSelectedItem().toString().trim().isEmpty()) {
                ...
                if (dialogResult == 0) {
                    try {
                        String sql = "INSERT INTO eslam.msrofat (employee,kind,type,amount,comment,date,fulldatee) VALUES"
                                + " ('" + employee.getText() + "','" + cmkind.getSelectedItem().toString() + "','" + cmtype.getSelectedItem().toString() + "','" + amountt + "','" + comment.getText() + "','" + date1.getText().toString() + "','" + dateee + "')";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            String sql = "DELETE FROM eslam.msrofat WHERE (fulldatee = '" + cmtype1.getSelectedItem().toString() + "');";
            pst = (PreparedStatement) con.prepareStatement(sql);
            pst.execute();
    ...
    private void save3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save3ActionPerformed
        ...
        if (typename.getText().trim().isEmpty()) {
            ...
            if (dialogResult == 0) {
                try {
                    String sql = "INSERT INTO eslam.types (name,employee) VALUES"
                            + " ('" + namee + "','" + cmtype2.getSelectedItem().toString() + "')";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    pst.execute();
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
        ...
        try {
            ...
            String sqll = "SELECT distinct fulldatee FROM eslam.msrofat  where 1=1 ";
        ...
        try {
            ...
            String sql = "SELECT * FROM eslam.msrofat where 1=1 ";
...
public void clear() {
    ...
    public void msroffat() {
        try {
            String sql = "SELECT name  FROM eslam.types ";
            pst = (PreparedStatement) con.prepareStatement(sql);
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public void comboxfromcombo1() {
        cmtype1.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    String sql = "SELECT * FROM eslam.msrofat where fulldatee='" + cmtype1.getSelectedItem().toString() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    while (rs.next()) {
    ...
    public void comboxfromcombo2() {
        cmtype.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent event) {
                ...
                try {
                    String sql = "SELECT * FROM eslam.types where name='" + cmtype.getSelectedItem().toString() + "'";
                    pst = (PreparedStatement) con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    while (rs.next()) {
